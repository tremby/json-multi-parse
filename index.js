...
const ERROR_REGEXES = [
	...
	/^()()Unexpected non-whitespace character after JSON at position (\d+)$/, // Node 20, Chromium 113
	/^()()Unexpected non-whitespace character after JSON at position (\d+) \(line (?:\d+) column (?:\d+)\)$/, // Node 22..24
